...
class UsuarioController {
    ...
    async atualizar(req, res) {
        ...
        /**
         * Converte o documento Mongoose para um objeto simples
         * Mesmo que usar .lean() no Mongoose, mas aqui é mais explícito
         */
        let usuarioLimpo = data.toObject();
        ...
        return CommonResponse.success(res, usuarioLimpo, 200, 'Usuário atualizado com sucesso. Porém, o e-mail é ignorado em tentativas de atualização, pois é operação proíbida. IDs de Unidades e Grupos não cadastradas são ignoradas.');
    }
